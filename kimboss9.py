...
def apisettings():
  choicest = input("""\033[1;32m  
   ...
   _)|  |_) _)[_| \||/[_|\
\033[1;0m
  === = api.com API Settings ===
  \033[1;33m
    1. Update Settings:
    2. Go Back:\033[1;0m
    Please enter your choice [1-2]: """)
  if choicest == "1":
          input_number = input("  \033[1;32m1.Enter api.com Phone number\033[1;0m\n")
          input_userid = input("  \033[1;32m2.Enter api.com UserID\033[1;0m\n") 
          input_token = input("   \033[1;32m3.Enter api.com Token\033[1;0m\n") 
          try:
...
def singlesms():
 ...
 \033[1;0m                         
  ...
  try:
    ...
    user = user1   # change ***** to your api user ID
    token = token1  # change ***** to your api token
    from_n = from2  # change ***** to your api SMS number
...
def bulksms():
  ...
  try:
    ...
    user = user1   # change ***** to your api user ID
    token = token1   # change ***** to your api token
    from1 = from2  # change ***** to your api SMS number
    ...
    messagesSent = 0
    host = "https://sms-international.p.rapidapi.com/WebTool/SMStoCountry/sms1"
    hdr = { 'User-Agent' : 'Mozilla/5.0 (Windows NT 6.1; Win64; x64)' }
    for x in numbers:
      messagesSent += 1
      params = {
